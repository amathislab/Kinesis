...
if __name__ == "__main__":
    ...
    with open("data/kit_train_keys_cleaned.txt", "r") as f:
        train_keys = f.readlines()
    train_keys = [key.strip() for key in train_keys]

    with open("data/kit_test_keys.txt", "r") as f:
    ...
    kit_train_motion_dict = {
        key: amass_full_motion_dict[key] for key in train_keys
    }
    ...
    joblib.dump(kit_train_motion_dict, "data/kit_train_motion_dict_new.pkl")
    joblib.dump(kit_test_motion_dict, "data/kit_test_motion_dict_new.pkl")